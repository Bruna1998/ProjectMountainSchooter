...
import sys
import pygame
from pygame import K_BACKSPACE, K_ESCAPE, K_RETURN, KEYDOWN, font,Surface,Rect
from DBProxy import DbProxy
from const import COLOR_ORANGE, COLOR_WHITE, COLOR_YELLOW, MENU_OPTION, SCORE_POS
